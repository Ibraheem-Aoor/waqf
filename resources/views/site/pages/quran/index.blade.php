                        ...
                        @foreach ($suwar as $sura)
                            <a class="widget__item-2" href="{{ route('site.quran.sura' , $sura['id']) }}" wire:key="1" data-name="{{ $sura['name'] }}">
                                <div class="widget__item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" height="20px" width="20px" version="1.1" id="Capa_1" viewBox="0 0 484.228 484.228" xml:space="preserve">
                                        <g>
