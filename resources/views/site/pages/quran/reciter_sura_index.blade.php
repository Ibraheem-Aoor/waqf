                    ...
                    <div class="col-12">
                        <div class="form-group mb-0">
                            <div class="inout-icon">
                                <input name="search" class="form-control" type="text" id="name"
                                    placeholder="ابحث بإسم السورة" onkeyup="filterList()">
                ...
                <div class="row">
                    <div class="col-12" id="list">
                        @foreach ($suwar as $sura)
                            <a class="widget__item-2"
                                href="{{ route('site.quran.reciter.listen', ['reciter' => $reciter['id'], 'sura' => $sura['id'], 'rewaya' => $rewaya]) }}"
                                data-name="{{ $sura['name'] }}">
                                <div class="widget__item-icon">
                                    <img src="https://waqfsawir.net/img//svg/play.svg" alt="">
                                </div>
